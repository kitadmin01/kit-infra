...
{{- define "analytickit.objectStorage.fullname" -}}
...
{{- else -}}
{{- printf "%s-%s" (include "analytickit.fullname" .) "minio" | trunc 63 | trimSuffix "-" -}}
{{- end -}}
{{- end -}}

{{/* Unify endpoint logic to support host, port specification */}}
{{- define "analytickit.externalObjectStorage.endpoint" -}}
...
{{/* Common Object Storage ENV variables and helpers used by AnalyticKit */}}
...
- name: OBJECT_STORAGE_ENDPOINT
  value: http://{{ include "analytickit.objectStorage.fullname" . }}:{{ .Values.minio.service.ports.api }}
...
{{- else if include "analytickit.externalObjectStorage.endpoint" . }}
- name: OBJECT_STORAGE_ENABLED
  value: "true"
- name: OBJECT_STORAGE_ENDPOINT
  value: {{ include "analytickit.externalObjectStorage.endpoint" . }}
- name: OBJECT_STORAGE_BUCKET
