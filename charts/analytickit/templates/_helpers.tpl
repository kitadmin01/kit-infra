...
{{- define "analytickit.zookeeper.fullname" -}}
...
{{- else -}}
{{- printf "%s-%s" (include "analytickit.fullname" .) "zookeeper" | trunc 63 | trimSuffix "-" -}}
{{- end -}}
{{- end -}}

{{/*
Set the analytickit image
*/}}
{{- define "analytickit.image.fullPath" -}}
{{ if .Values.image.sha -}}
...
Set zookeeper host
*/}}
{{- define "analytickit.zookeeper.host" -}}
{{- include "analytickit.zookeeper.fullname" . -}}
{{- end -}}

{{/*
Set zookeeper port
*/}}
{{- define "analytickit.zookeeper.port" -}}
    2181
{{- end -}}
...
*/}}
{{- define "analytickit.redis.host" -}}
{{- if .Values.redis.enabled }}
    {{- printf "%s-master" (include "analytickit.redis.fullname" .) -}}
{{- else -}}
...
*/}}
{{- define "analytickit.redis.createSecret" -}}
...
*/}}
{{- define "analytickit.redis.secretName" -}}
{{- if .Values.redis.enabled }}
    {{- if .Values.redis.auth.existingSecret }}
        {{- printf "%s" .Values.redis.auth.existingSecret -}}
    {{- else -}}
        {{- printf "%s" (include "analytickit.redis.fullname" .) -}}
    {{- end -}}
{{- else if .Values.externalRedis.existingSecret }}
    {{- printf "%s" .Values.externalRedis.existingSecret -}}
{{- else -}}
    {{- printf "%s-external" (include "analytickit.redis.fullname" .) -}}
{{- end -}}
{{- end -}}
...
*/}}
{{- define "analytickit.redis.secretPasswordKey" -}}
...
*/}}
{{- define "analytickit.redis.auth.enabled" -}}
...
*/}}
{{- define "analytickit.serviceAccountName" -}}
{{- if .Values.serviceAccount.create -}}
    {{ default (include "analytickit.fullname" .) .Values.serviceAccount.name }}
{{- else -}}
    {{ default "default" .Values.serviceAccount.name }}
{{- end -}}
{{- end -}}

{{- define "analytickit.helmOperation" -}}
...
{{- define "analytickit.helmInstallInfo" -}}
{{- $info := dict }}
...
{{- $info := set $info "operation" (include "analytickit.helmOperation" .) -}}
...
{{- define "analytickit.deploymentEnv" -}}
