...
echo "printf 'Hello 🦔! To install AnalyticKit into k8s run this:\n\n "helm upgrade --install analytickit charts/analytickit -f .devcontainer/values.yml --namespace analytickit --create-namespace"\n'" >> ~/.zshrc
